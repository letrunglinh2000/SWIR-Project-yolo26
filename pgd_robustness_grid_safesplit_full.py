...
RUNS = ["yolo26n_nslsr_safesplit","yolo26s_nslsr_safesplit","yolo26n_nslsr_pgd_safesplit","yolo26s_nslsr_pgd_safesplit"]
MODELS = {}
for run in RUNS:
    for ckpt in ["best","last"]:
        MODELS[f"{run}__{ckpt}"] = BASE/f"runs/train/{run}/weights/{ckpt}.pt"
...
if __name__ == "__main__":
    ...
    with open(BASE / "pgd_robustness_grid_safesplit_full_results.json", "w") as f:
