...
YAML_PATH = BASE / "dataset.yaml"   # same (leaky) split the existing table used -- flagged, not fixed yet
DEVICE = "0"
IMGSZ = 640
BATCH_SIZE = 8
WORKERS = 0  # sandbox blocks multiprocessing pipe creation; single-process loading only

# Canonical, independent robustness probe -- stronger than the 3-step attack used during PGD training
PGD_EPS = 8.0/255.0
PGD_ALPHA = 2.0/255.0
PGD_STEPS = 20

MODELS = {
    "yolo26n_clean_best": BASE/"runs/train/yolo26n_nslsr/weights/best.pt",
    "yolo26n_clean_last": BASE/"runs/train/yolo26n_nslsr/weights/last.pt",
    "yolo26n_pgd_best":   BASE/"runs/train/yolo26n_nslsr_pgd/weights/best.pt",
    "yolo26n_pgd_last":   BASE/"runs/train/yolo26n_nslsr_pgd/weights/last.pt",
    "yolo26s_clean_best": BASE/"runs/train/yolo26s_nslsr/weights/best.pt",
    "yolo26s_clean_last": BASE/"runs/train/yolo26s_nslsr/weights/last.pt",
    "yolo26s_pgd_best":   BASE/"runs/train/yolo26s_nslsr_pgd/weights/best.pt",
    "yolo26s_pgd_last":   BASE/"runs/train/yolo26s_nslsr_pgd/weights/last.pt",
}
...
if __name__ == "__main__":
    ...
    with open(BASE / "pgd_robustness_grid_results.json", "w") as f:
