...
YAML_PATH = BASE / "dataset_safesplit.yaml"   # leakage-safe segment split this time
DEVICE = "0"
IMGSZ = 640
BATCH_SIZE = 8
WORKERS = 0
...
MODELS = {
    "yolo26n_safesplit_clean": BASE/"runs/train/yolo26n_nslsr_safesplit/weights/best.pt",
    "yolo26n_safesplit_pgd":   BASE/"runs/train/yolo26n_nslsr_pgd_safesplit/weights/best.pt",
    "yolo26s_safesplit_clean": BASE/"runs/train/yolo26s_nslsr_safesplit/weights/best.pt",
    "yolo26s_safesplit_pgd":   BASE/"runs/train/yolo26s_nslsr_pgd_safesplit/weights/best.pt",
}
...
if __name__ == "__main__":
    ...
    with open(BASE / "pgd_robustness_grid_safesplit_results.json", "w") as f:
